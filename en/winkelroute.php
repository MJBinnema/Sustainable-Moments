...
?>
<script>
    $(".card-title ").html("Shopping route<br/> Sustainable Moments");
    $('.card-sub').css('display', 'none');
</script>
    <!-- meta titel en beschrijving -->
    <meta name="title" content="Winkelroute">
	<meta name="description" content="Discover opportunities for a more conscious lifestyle on our Sustainable shopping route, with all sustainable hotspots in Groningen. Come along and be inspired by everything Groningen has to offer: from local designers doing sustainable projects to restaurants that only work with local products.">
    <!-- einde meta-->
    <div class="bg-lichtgroen text-white"> 
        <div class="container py-5 text-md-center">
            <div class="mx-sm-auto small-div" style="width: 50%;">
                <p>
                    Discover opportunities for a more conscious lifestyle on 
                    our Sustainable shopping route, with all sustainable hotspots 
                    in Groningen. Come along and be inspired by everything 
                    Groningen has to offer: from local designers doing 
                    sustainable projects to restaurants that only work with local products.
                </p>
    ...
    <div class="container pt-3 pb-5">
        <div>  
            <?php
                ...
                if($page > 1){ 
                    echo "<a href='winkelroute.php?page=1#evenement'>First</a>";
                ...
                if($page < $end_loop){
                    echo "<a href='winkelroute.php?page=".($page + 1)."#evenement'>></a>";
                    echo "<a href='winkelroute.php?page=".$total_pages."#evenement'>Last</a>";
                }
                echo '</div>'
            ?>
        </div>
