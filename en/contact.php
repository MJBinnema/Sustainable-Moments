    ...
    <div class="container py-5">
        ...
        <div class="row">
            <div class="col col-12 col-sm-12 col-md-8 col-lg-8">
                <h5 class="pb-2">Get in contact</h5>
                    ...
                    <div>
                        <div class="offset-top-10">
                            <form role="form" id="feedbackForm">
                                <div class="form-group">    
                                    <input type="text" class="form-control" id="name" name="name" placeholder="Name" <?php if(!empty($_POST['name'])){echo "value=\"".$_POST['name']."\"";}?>>
                                    <?php echo "<p class=\"text-danger\">".$errName."</p>";?>
                                </div>
                                <div class="row">
                                    <div class="col col-12 col-sm-12 col-md-6 col-lg-6">
                                        <div class="form-group">
                                            <input type="text" class="form-control" id="phone" name="phone" placeholder="Phone number" <?php if(!empty($_POST['phone'])){echo "value=\"".$_POST['phone']."\"";}?>>
                                ...
                                <div class="form-group offset-top-45">
                                    <textarea rows="11" cols="100" class="form-control" id="message" name="message" placeholder="Message"></textarea><?php if(!empty($_POST['message'])){echo $_POST['message'];}?></textarea>
                                    <?php echo "<p class=\"text-danger\">".$errMessage."</p>";?>
                                </div>
                            </form>
                            <input id="submit" name="submit" type="submit" value="Send" class="btn btn-groenrood w-100">
                        </div>
                    </div>
                </form>
            ...
            <div class="col col-12 col-sm-12 col-md-4 col-lg-4">
                ...
                <h6 class="pt-3">Follow us on social media</h6>
				<div>
