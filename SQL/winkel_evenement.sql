...
--
-- Host: 127.0.0.1
-- Gegenereerd op: 27 sep 2019 om 00:13
...
--
-- Tabelstructuur voor tabel `winkel_evenement`
--

CREATE TABLE `winkel_evenement` (
  `id` int(10) NOT NULL,
...
--
-- Gegevens worden geëxporteerd voor tabel `winkel_evenement`
--

INSERT INTO `winkel_evenement` (`id`, `evenement_naam`, `dag`, `datum`, `tijd`, `plaats`, `adres`, `kost`, `beschrijving_kort`, `beschrijving`, `beschrijving_engels`, `facebook_link`) VALUES
...
--
-- Indexen voor tabel `winkel_evenement`
--
ALTER TABLE `winkel_evenement`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT voor een tabel `winkel_evenement`
--
ALTER TABLE `winkel_evenement`
