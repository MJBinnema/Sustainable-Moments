...
echo '<a href="evenement.php?id=' . $row->id . '" class="a-evenementpanel">';
...
echo            '<img class="d-block w-100 h-100 img-responsive" src="../images/evenementen/evenement-' . $row->id . '.png" alt="' . $row->evenement_naam . '">';
echo        '</div>';
...
echo                     '</div>';
echo                 '</div>';
echo                 '<p class="card-text pt-2">' . $row->beschrijving_kort . ' <span class="a-leesmeer">lees meer</span></p>';
echo            '</div>';
echo        '</div>';
echo    '</div>';
echo '</div>';
